...
\begin{figure}
	...
	\begin{subfigure}{0.45\textwidth}
		...
		\caption{Stretching factor $\kappa = 0.868$, redshift $z = 0.934$, off-axis angle $\chi = 4.65\times 10^{-4}$.}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.45\textwidth}
		\includegraphics[width=\textwidth]{sampleLightCurveLogPositive}
		\label{fig:sampleLightCurveLogPosivie}
		\caption{Stretching factor $\kappa = 5.33$, redshift $z = 0.229$, off-axis angle $\chi = 8.97\times 10^{-3}$.}
	\end{subfigure}
	\hspace*{\fill}
	\caption{
		High and low energy light curves produced by the geometrical model. Burst parameter values are the same as discussed in section \ref{sec:parameters}.
	}
...
\begin{table}
	...
	\begin{tabular}{ S[table-format=2.4] | S[table-format=1.5] | S[table-format=-1.6] | S[table-format=-1.7] | S[table-format=1.8] }
		...
		\hline
		22.1525	&	$\mathrm{2.16424 \times 10^{-4}}$ 	&	-0.417021  	&	-1.3516300 	&	0.00704982 	\\
...
\begin{figure}
	...
	\end{subfigure}
	\hspace*{\fill}
	\caption{Stretching factors histogram and CDF produced by our model. The sample contains $256$ bursts.}
...
\begin{figure}
        ...
        \caption{Correlations between off-axis angles, stretching factors and high to low energy photon count ratios found in the sample produces by our model. The sample contains $16$ bursts. Black crosses show observations. This correlation allows to estimate off-axis angles of observed bursts.}
