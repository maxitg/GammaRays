...
We use 41 energy bins from \unit[100]{MeV} to \unit[1]{TeV}, and 300 angular bins with maximal angle being $30\degree$.
...
The exposure map can be computed with the \texttt{gtexpcube2}\footnote{\url{http://fermi.gsfc.nasa.gov/ssc/data/analysis/scitools/help/gtexpcube2.txt}} tool. We compute it with 40 energy bins from \unit[100]{MeV} to \unit[1]{TeV}.
