...
the are arguments in support of our model. 
...
and to ensure that it doesn't exceed the mass of the star from which
...
to avoid production of too many points corresponding to an invisible
...
redshift to be $0$, we select it to be a small number $z_\text{min}$.
...
\alpha\right)$, and 2 of the observers position related to the burst
...
higher of lower than 1, that is the higher or the lower-energy light
curve is stretched.
