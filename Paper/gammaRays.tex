...
\begin{itemize}
	...
	\item{
		{\bf Observation dates}. We extend the duration of the burst by $15\%$ relative to the table \ref{tab:bursts} values to both past and future to have a decent safety margin. So the time ranges we fill in here are:
		\begin{align*}
...
The data we downloaded contains a lot of background and radiation from other sources. We need to filter it before using it.
