...
\section{Introduction}
	...
	For the GRB 090902B it is smaller than 1, so the low energy light curve is stretched with respect to the high energy one (see fig. \ref{fig:grb090902B}).
	And for the GRB 090926A even more dramatic deviation from the stretching factor of 1 is observed in the opposite direction.
