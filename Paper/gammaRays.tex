...
\begin{abstract}
	It is known that the high energy $(> \unit[100]{MeV})$
        ...
        photons were observed with energy greater than
        ...
        $\unit[1]{GeV} < E < \unit[300]{GeV}$. For GRB 080916C and GRB
        090510 the light curves in two bands are statistically
        ...
        data. Finally, we propose a way to estimate observer's
        off-axis angle based on stretching factor and fraction of the
...
bursts have similar energetics in their rest frames. Several
...
\cite{Castignani:2014gaa,Lange:2013uh,Vianello:2013ela}.

%% change the next statement
	We decided to elaborate on that result, and, using the data
        from Large Area Telescope (LAT) of Fermi satellite~\cite{Ackermann:2012kna}, explore the spectral variations between different high energy bands, specifically $(\unit[100]{MeV}, \unit[1]{GeV})$ and $(\unit[1]{GeV}, \unit[300]{GeV})$ (we call them low and high energy bands throughout the paper).
