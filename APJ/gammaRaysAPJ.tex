...
of magnitude~\citep{Bloom:2003wy}. This indicates that the most of the
...
the synchrotron radiation scenario~\citep{Wang:2013ptaw}.  Several
...
\citep{Yi:2005ht} and the very-high-energy radiation was discovered to
...
authors \citep{Nakamura:2001kd,Shen:2005ea,Shenoy:2013cba}.  These
...
existed at very small redshifts, the burst density should decline
...
\begin{itemize}
	...
	\item{If we make a simultaneous transformation of $r_0
          \rightarrow \lambda r_0$ and $\eta_0 \rightarrow
          \frac{1}{\lambda^3}\eta_0$, where $\lambda$ is a parameter
	...
	\item{Finally, if we make a following transformation:
          $\omega_0 \rightarrow \lambda \omega_0$, $\theta_0
          \rightarrow \lambda^k \theta_0$, $\eta_0 \rightarrow
          \lambda^\alpha \eta_0$, where $\lambda$ is another
...
The best fit parameters are found by minimizing the cost function
$C\left(n, \theta_0, k, \alpha, \chi\right)$ which should
