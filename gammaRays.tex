...
\begin{figure}[kappaDistribution]
        ...
        \end{subfigure}
        \caption{The histogram and the CDF of the stretching factors sample produced by our model (blue). The sample contains $300$ points. The red curve is an empirical CDF of the observed sample (3 points).}
...
The ratio for our set of parameters is $f_m = 0.072$. The LAT burst catalog \cite{Ackermann:2013zfa} contains $n = 35$ bursts, $3$ of which were observed in the energy range $\left(1\text{GeV}, \infty\right)$. So the ratio is $f_o = \frac{3}{35} \approx 0.086$. The binary distribution gives us the probability for it to happen:
\begin{equation}
