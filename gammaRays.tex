...
\begin{figure}[kappaDistribution]
        ...
        \end{subfigure}
        \caption{The histogram and the CDF of the stretching factors sample produced by our model. The sample contains $200$ points. You can see the stretching factors computed from the observations below the $\kappa$ axis (not yet implemented).}
