...
\begin{figure}[kappaDistribution]
        ...
        \end{subfigure}
        \caption{The histogram and the CDF of the stretching factors sample produced by our model (blue). The sample contains $250$ points. The red curve is an empirical CDF of the observed sample (3 points).}
...
The ratio for our set of parameters is $f_m = 0.072$. The LAT burst catalog \ref{LATbc} contains $n = 35$ bursts, $3$ of which were observed in the energy range ${1\text{GeV}, \infty}$. So the ratio is $f_o = \frac{3}{35} \approx 0.086$. The binary distribution gives us the probability for it to happen:
\begin{equation}
\text{Pr}\left(k_o = k\right) = \frac{n}{k} f^k \left(1-f\right)^{n-k} \approx 0.223585
\end{equation}
