...
{\bf Fig.~6.}~Correlation between the high energy photon fraction, the observer's off-axis angle, and the stretching factor found in the sample produces by our model. Black crosses show observations. This correlation allows one to estimate observer's off-axis angles of real bursts.
